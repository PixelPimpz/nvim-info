...
tmux set-hook -g pane-exited[1] 'refresh-client'
tmux set-hook -g session-created[0] 'run "#{@PLUG_ROOT}/get_cur_buffer"'
tmux set-hook -g session-created[1] 'refresh-client'
tmux set-hook -g session-window-changed[0] 'run "#{@PLUG_ROOT}/get_cur_buffer"'
tmux set-hook -g session-window-changed[1] 'refresh-client'
tmux set-hook -g after-new-window[0] 'run "#{@PLUG_ROOT}/get_cur_buffer"'
tmux set-hook -g after-new-window[1] 'refresh-client'
tmux set-hook -g after-new-session[0] 'run "#{@PLUG_ROOT}/get_cur_buffer"'
tmux set-hook -g after-new-session[1] 'refresh-client'
tmux set-hook -g sessions-changed[0] 'run "#{@PLUG_ROOT}/get_cur_buffer"'
tmux set-hook -g sessions-changed[1] 'refresh-client'
